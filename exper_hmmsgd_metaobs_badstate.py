...
if __name__ == "__main__":
    """ This test contains one bad state that transitions randomly to every
        other state while every other state prefers to stay stationary.
    """
    name = 'exper_hmmsgd_metaobs_synth_badstate'
    datadir = 'data'
    datafn = 'synth_badstate_T100'
    expdir = None
    nfolds = 3
    nrestarts = 2
    seed = 8675309
