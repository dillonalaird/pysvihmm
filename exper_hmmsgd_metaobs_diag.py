...
if __name__ == "__main__":
    """ This experiment runs a transition matrix where states mostly transition
        back to themsevles and every once in awhile transition to the next
        state. Since the emissions are nicely separated, we'd expected the
        algorithm to do well, assuming that every state has been visited.
    """

    name = 'exper_hmmsgd_metaobs_synth_daig'
    datadir = 'data'
